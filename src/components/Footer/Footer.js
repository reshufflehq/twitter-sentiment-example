...
export default function Footer() {
  return (
    <footer>
      ...
      <div>
        <br></br>
        Life is work in Progress - This is an open source project, you can check
        the source, remix it, and run your own at this{' '}
        <a href='https://reshuffle.com/template/twitter-sentiment-analysis'>
          Reshuffle template
        </a>
        .
      </div>
